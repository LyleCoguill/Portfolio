...
export default function About() {
  return (
    <>
      <Head>
        <title>About - Lyle Coguill</title>
        <meta
          name="description"
          content="I’m Lyle Coguill. I live in Colorado, where I design the future."
        />
      </Head>
        ...
        <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
          ...
          <div className="lg:order-first lg:row-span-2">
            <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
              I’m Lyle Coguill. I live in Colorado, where I design the future.
            </h1>
            <div className="mt-6 space-y-7 text-base text-zinc-600 dark:text-zinc-400">
              ...
              <p>
                ...
                have been hooked. The fusion of elegant front-end artwork and
                the intricacies of back-end logic captivates me, and I find
          ...
          <div className="lg:pl-20">
            <ul role="list">
              ...
              <SocialLink
                href="mailto:lcoguill@gmail.com"
                icon={MailIcon}
